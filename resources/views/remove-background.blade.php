...
<body class="bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 min-h-screen flex flex-col items-center py-12 px-4">
    ...
    <h1 class="text-3xl font-bold mb-8 text-center text-indigo-700">Remove Image Background</h1>
    ...
    <form action="{{ route('remove.bg.process') }}" method="POST" enctype="multipart/form-data" class="w-full max-w-lg bg-white p-6 rounded shadow">
        @csrf
        <div class="mb-4">
    ...
    @isset($image)
        <div class="mt-10 text-center">
            ...
            <a href="data:image/png;base64,{{ $image }}" download="background-removed-{{ time() }}.png"
